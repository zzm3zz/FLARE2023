...
from nnunet.network_architecture.network_other import init_weights
...
class MultiAttentionBlock(nn.Module):
    ...
    def forward(self, input, gating_signal):  # 高分辨率和低分辨率的输入
        gate_1, attention_1 = self.gate_block_1(input, gating_signal)  # xh
        gate_2, attention_2 = self.gate_block_2(input, gating_signal)  # xl
