...
class ImageCropper_test(object):
    ...
    @staticmethod
    def crop_test(data, properties, seg=None):
    ...
    @staticmethod
    def crop_from_list_of_files_test(data_files, seg_file=None):
        # print(data_files)
        # print(seg_file)
        data, seg, properties = load_case_from_list_of_files(data_files, seg_file)
        # print('6666')
        # print(ImageCropper.crop(data, properties, seg))
        return ImageCropper_test.crop_test(data, properties, seg)
    ...
    def load_crop_save(self, case, case_identifier, overwrite_existing=False):
        try:
            ...
            if overwrite_existing \
                ...
                # print('99999')
                # print(case)
                data, seg, properties = self.crop_from_list_of_files_test(case[:-1], case[-1])
                # print('222222')
